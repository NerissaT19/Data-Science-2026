...
- Prices for 2-2.5 carat diamonds are skewed towards the higher end of
  their range, while prices for 1-1.5 carat diamonds are skewed towards
  the lower end of their range.
- There is a sharp increase in the maximum price of a diamond around 1
  carat.
...
- Diamonds with a “fair” cut have the greatest range in carats, while
  diamonds with a “good” cut have the smallest range.
- Lower carat diamonds generally have the lowest prices.
- Higher prices become more frequent as the quality of a diamond’s cut
  increases.
- The majority of diamonds are less than 2.5 carats.
- Higher carats does not always mean higher prices, as many of the
  larger outlier values in each cut category have lower prices than
  diamonds with carat values in the mid-range.
- For the “very good and”ideal” cuts, there is a sharp increase in the
  typical price of a diamond beginning at around 1 carat. For the
  “premium” cut, this increase happens beginning around 1.25 carats.
