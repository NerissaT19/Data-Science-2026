...
## Your code here!
LIGHTSPEED_MICHELSON - LIGHTSPEED_VACUUM  ## Michelson's true error
```

    ## [1] 151.542

``` r
LIGHTSPEED_PM                             ## Plus/minus bounds of Michelson's estimate
```
...
- Make a quantitative comparison between Michelson’s uncertainty and his
  error.
  - Michelson’s uncertainty was about 100 off from, or three times, his
    true error.
...
``` r
## Creates visualization comparing velocity in a vacuum, date, and distinctness 
df_q2 %>%
...
- The widest range of velocities observed occurred when the distinctness
  was 2.
- When the distinctness was 3, there were the lowest number of
  occurrences of temperatures below 70 degrees.
- Velocities over 300,000 km/s were only recorded when the distinctness
  was 2 or 3.
- The most common distinctness was 3, while the least common
  distinctness was 1.
- All the times when the distinctness was 1 occurred in the first half
  of the experiment.
