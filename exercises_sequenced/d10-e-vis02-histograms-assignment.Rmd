...
- Which `class` has the broadest distribution of `cty` values?
  - Subcompact cars have the broadest distribution of `cty` values.
  
- Which graph---`vis1` or `vis2`---best helps you answer each question?
  - `vis1` best helps answer question 1, while `vis2` best helps answer question 2.
...
**Observations**
- When the binwidth is 0.0075, there are spikes in count around 0.3, 0.4, 0.5, 0.7, 0.9, and 1 carat.
- When the binwidth is 0.01, there are spikes in count around 0.3, 0.4, 0.5, 0.7, 0.9, and 1 carat.
- When the binwidth is 0.05, there are spikes in count around 0.3, 0.5, 0.7, and 1 carat.
- When the binwidth is 0.075, there are spikes in count around 0.3, 0.7, and 1 carat.
- Across all binwidths, there are obvious spikes in count around 0.3, 0.7, and 1 carat. The largest spike is always at 0.3 carats.
