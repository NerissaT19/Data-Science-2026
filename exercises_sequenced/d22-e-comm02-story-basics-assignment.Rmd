...
**Classify**:
AAA, ABT, or DHY?
The graph is closest to ABT. 

**Justify**
Write your justification here!
Diamond prices relate to carat AND cut, BUT greater carat values tend to result in higher prices rather than better cut quality, THEREFORE carat likely has a greater effect on price than cut. 
...
**Classify**:
AAA, ABT, or DHY?
The graph is closed to AAA. 

**Justify**
Write your justification here!
The graph has a lot of information on top of each other. The crowding makes it hard to read and gives the same effect as constantly stacking on "ands" to a story.  
...
**Classify**:
AAA, ABT, or DHY?
The graph is closest to DHY.

**Justify**
Write your justification here!
The graph shows seven different relationships between variables in the dataset. It doesn't follow a specific "story," because it keeps branching off into other narratives. 
