...
**Observations**:
- The plot makes it seem like the highway miles per gallon are always about 30 when the city miles per gallon are 20, but when looking at the actual dataset, we can see that the highway miles per gallon vary when the city miles per gallon are 20. The `cty` values are "stacking" in the plot and it doesn't give a good representation of the data.
...
**Observations**:
- SUVs are the most common class of cars.
- 2 seaters are the least common class of cars.
- Most cars have four or five seats.
...
- SUVs are the most common class of cars.
- 2 seaters are the least common class of cars.
- Rear wheel drive is the least common type of drive train.
- 2 seaters, minivans, and pickups all have no variety in drive train types. The 2 seaters only have rear wheel drive, the minivans all have front wheel drive, and the pickups all have 4 wheel drive.
- No SUVs in the dataset have front wheel drive.
- Larger cars are more likely to have 4 wheel drive.
...
`v1` had solidly colored bars that only showed the count of each type of car, while `v2` had separated colors inside the bars that showed the distribution of drive train types across the count of each type of car.
...
**Observations**
- Honda, Jeep, Land Rover, Lincoln, Mercury, and Pontiac all only have 1 class of car in the dataset.
- Toyota has the most variety in car types in the dataset.
- Most manufacturers with only one type of car make SUVs.
- Chevrolet is the only manufacturer with 2 seater cars in the dataset.
- Manufacturers with more variety in car types have more representation in the dataset.
