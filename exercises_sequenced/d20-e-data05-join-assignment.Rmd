...
- The first names do not line up with the correct last names and instruments. This happened because we simply connected the two sets of columns in their original order, and the orders of the sets did not correctly line up. 
...
```{r q2-task}
df_q21 <- cross_join(beatles1, beatles2)
df_q2 <- inner_join(beatles3, df_q21)
...
```{r q4-task}
criteria <- expand_grid(dest = c("SFO", "SJC", "OAK"), month = c(8, 9))
