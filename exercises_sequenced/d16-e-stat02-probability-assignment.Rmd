...
I predicted that the value would be 0.5.

- Did your prediction match your calculation?
My prediction was close to my calculation, but it didn't exactly match it.
...
`p0` is the same as my `fr` prediction from q1.
